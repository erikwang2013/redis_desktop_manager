...
#include "../../../../src/modules/common/tabmodel.h"
...
struct qt_meta_stringdata_TabModel_t {
    QByteArrayData data[3];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TabModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TabModel_t qt_meta_stringdata_TabModel = {
    {
QT_MOC_LITERAL(0, 0, 8), // "TabModel"
...
const QMetaObject TabModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TabModel.data,
      qt_meta_data_TabModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TabModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TabModel.stringdata0))
